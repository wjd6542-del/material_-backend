...
export default async function outboundRoutes(app) {
  /**
   * 출고 전표 전체 리스트
   * @route POST /api/outbound/allList
   */
  ...
  /**
   * 출고 현황 집계 (보드/대시보드 카운트)
   * @route POST /api/outbound/boardCount
   */
  ...
  /**
   * 출고 상세 아이템 리스트
   * @route POST /api/outbound/detail/list
   */
  ...
  /**
   * 반품 가능 출고 아이템 목록 조회 (반품 전표 작성 화면용)
   * @route POST /api/outbound/returnList
   */
  ...
  /**
   * 출고 단건 삭제 (재고 복원 + 이력 기록)
   * @route POST /api/outbound/delete
   */
  ...
  /**
   * 출고 전표 생성/수정 (재고 차감 + 이동평균 원가 적용 + 이익 계산)
   * @route POST /api/outbound/save
   */
  ...
  /**
   * 출고 전표 일괄 저장
   * @route POST /api/outbound/batchSave
   */
  ...
  /**
   * 출고 전표 일괄 삭제
   * @route POST /api/outbound/batchDelete
   */
